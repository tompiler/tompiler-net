...
const data = {
  ...
  skillCategoryLinks: [
    ...
    { key: 9, y0: timelineNodes.infinityWorks, y1: skillCategories.python },
    {
      key: 10,
      y0: timelineNodes.infinityWorks,
    ...
    { key: 20, y0: timelineNodes.decathlonUK, y1: skillCategories.python },
    { key: 21, y0: timelineNodes.decathlonUK, y1: skillCategories.etl },

    { key: 22, y0: timelineNodes.decathlonUK, y1: skillCategories.aws },

    { key: 23, y0: timelineNodes.decathlonUK, y1: skillCategories.API },
    { key: 24, y0: timelineNodes.decathlonUK, y1: skillCategories.databases },
    { key: 25, y0: timelineNodes.decathlonUK, y1: skillCategories.testing },
    { key: 26, y0: timelineNodes.decathlonUK, y1: skillCategories.os },
    { key: 27, y0: timelineNodes.decathlonUK, y1: skillCategories.other },
    {
      key: 28,
    ...
    { key: 38, y0: timelineNodes.ratedPeople, y1: skillCategories.python },
    { key: 39, y0: timelineNodes.ratedPeople, y1: skillCategories.etl },
    { key: 40, y0: timelineNodes.ratedPeople, y1: skillCategories.databases },
    { key: 41, y0: timelineNodes.mindshareWW, y1: skillCategories.python },
    { key: 42, y0: timelineNodes.mindshareWW, y1: skillCategories.etl },
    { key: 43, y0: timelineNodes.mindshareWW, y1: skillCategories.databases },
  ],
  skillItemLinks: [
    {
      key: 1,
